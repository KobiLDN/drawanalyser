...
|---|---|---|
| 2026-05-14 19:45 | Composer (Cursor) | Overwrote root `index.html` from `staging/index.html` again so local `file://` matches the staging canonical copy; restored DEEP RESEARCH topbar badge. Bumped to `v2.23`. |
